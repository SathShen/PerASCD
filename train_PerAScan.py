...
from models.PerAScan import PerAScan
NET_NAME = 'PerASCan'
DATA_NAME = 'SECOND'
DATA_PATH = r'/home/sht/Datasets/SECONDbitrain05/'
NOTE = 'vitg01m0C15LsscTau001Train05'
###############################################
# Training options
###############################################
args = {
...
def train(train_loader, net, criterion, optimizer, val_loader, curr_epoch=0, bestFscdV=0.0):
    ...
    while True:
        ...
        for i, data in enumerate(tqdm(train_loader, ncols=80)):
            ...
            adjust_lr(optimizer, iter_ratio, warmup_ratio=args['warmup_ratio'])
