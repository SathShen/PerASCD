...
def train(train_loader, net, criterion, optimizer, val_loader, curr_epoch=0, bestFscdV=0.0):
    ...
    while True:
        ...
        for i, data in enumerate(tqdm(train_loader)):
            ...
            #         io.imsave(os.path.join(args['log_dir'], NET_NAME + imgs_id[0] + '_psdA_epoch%diter%d.png'%(curr_epoch, running_iter)), psdA_color)
            #         io.imsave(os.path.join(args['log_dir'], NET_NAME + imgs_id[0] + '_psdB_epoch%diter%d.png'%(curr_epoch, running_iter)), psdB_color)
